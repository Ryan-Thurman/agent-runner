...
def _review_prompt(
    ...
    *,
    ...
    return (
        ...
        "- Plan lifecycle metadata is out of review scope. Do not request changes "
        "to a phase's `Status:` or `Evidence:` lines, or closeout handoff files: "
        "the runner's CLOSE_PHASE job writes them only after an accepted review.\n"
